insert into blog.users (email, is_moderator , name, password, reg_time) values
    ('mail@mail.ru', 1, 'first', '1', '2021-01-01 18:34:11'),
    ('mail@mail.ru', 0, 'second', '2', '2021-01-02 18:34:11'),
    ('mail@mail.ru', 0, 'third', '3', '2021-01-03 18:34:11'),
    ('mail@mail.ru', 1, '4th', '4', '2021-01-04 18:34:11');

insert into blog.posts (is_active, moderation_status, moderator_id, `text`, `time`, title, view_count, user_id) values
    (0, 'NEW', 1, '1', '2021-01-05 18:34:11', 'title1', 0, 1),
    (0, 'NEW', 1, '2', '2021-01-05 18:35:11', 'title2', 0, 1),
    (0, 'NEW', 1, '3', '2021-01-05 18:36:11', 'title3', 0, 1),
    (0, 'NEW', 1, '4', '2021-01-05 18:37:11', 'title4', 0, 3),
    (0, 'NEW', 1, '5', '2021-01-05 18:38:11', 'title5', 0, 2),
    (0, 'NEW', 1, '6', '2021-01-05 18:39:11', 'title6', 0, 2);
